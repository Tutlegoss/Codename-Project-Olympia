    ...
    public partial class ScoringForm : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (selected == "Ice Dance Mens")
            {
                ...
                string ViewTable = "SELECT * FROM \"Ice Dance Mens Scores\"";//gets team table from database
                using (System.Data.SQLite.SQLiteConnection con = new System.Data.SQLite.SQLiteConnection("data source=OlympiaDB.sqlite"))
                {
                    using (System.Data.SQLite.SQLiteCommand com = new System.Data.SQLite.SQLiteCommand(con))
                    {
            ...
            if (selected == "Ice Dance Womens")
            {
                ...
                string ViewTable = "SELECT * FROM \"Ice Dance Womens Scores\"";//gets team table from database
                using (System.Data.SQLite.SQLiteConnection con = new System.Data.SQLite.SQLiteConnection("data source=OlympiaDB.sqlite"))
                {
                    using (System.Data.SQLite.SQLiteCommand com = new System.Data.SQLite.SQLiteCommand(con))
                    {
            ...
            if (selected == "Single Skating Mens")
            {
                ...
                string ViewTable = "SELECT * FROM \"Single Skating Men Scores\"";//gets team table from database
                using (System.Data.SQLite.SQLiteConnection con = new System.Data.SQLite.SQLiteConnection("data source=OlympiaDB.sqlite"))
                {
                    using (System.Data.SQLite.SQLiteCommand com = new System.Data.SQLite.SQLiteCommand(con))
                    {
            ...
            if (selected == "Single Skating Womens")
            {
                ...
                string ViewTable = "SELECT * FROM \"Single Skating Womens Scores\"";//gets team table from database
                using (System.Data.SQLite.SQLiteConnection con = new System.Data.SQLite.SQLiteConnection("data source=OlympiaDB.sqlite"))
                {
                    using (System.Data.SQLite.SQLiteCommand com = new System.Data.SQLite.SQLiteCommand(con))
                    {
            ...
            if (selected == "Pair Skating Scores")
            {
                ...
                string ViewTable = "SELECT * FROM \"Pair Skating Scores\"";//gets team table from database
                using (System.Data.SQLite.SQLiteConnection con = new System.Data.SQLite.SQLiteConnection("data source=OlympiaDB.sqlite"))
                {
                    using (System.Data.SQLite.SQLiteCommand com = new System.Data.SQLite.SQLiteCommand(con))
                    {
